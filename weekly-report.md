...
- **有参数**（如 `/weekly-report C:\path\to\new_file.xlsx`）：
  1. 将用户提供的路径写入临时文件 `C:\Users\YOUR_USERNAME\YOUR_WORKSPACE\_data_source_path.txt`
...
```bash
PYTHONIOENCODING=utf-8 python "C:\Users\YOUR_USERNAME\YOUR_WORKSPACE\generate_html_report.py"
```
...
- 脚本路径固定为：`C:\Users\YOUR_USERNAME\YOUR_WORKSPACE\generate_html_report.py`
