...
```bash
python "C:\Users\gillian.yin\data_workspace\03_aiagent\finalize_report.py"
```
...
> ✅ 报表已正式输出！
> 
> - HTML 报表：`C:\Users\gillian.yin\data_workspace\03_aiagent\weekly_report.html`
> - Excel 报表：`C:\Users\gillian.yin\data_workspace\03_aiagent\weekly_report.xlsx`（含总览 + 各 BU 分 sheet）
> 
> 你可以直接用浏览器打开 HTML 文件，或用 Excel 打开 xlsx 文件查看。

## 注意事项

- 脚本路径：`C:\Users\gillian.yin\data_workspace\03_aiagent\finalize_report.py`
